...
::: {.content}
::: {#node-113 .node .node-patterns .node-promoted .node-full .clearfix about="/pattern/enhancing-dcat-10-dataset-metadata-prov-provenance" typeof="sioc:Item foaf:Document"}
[]{.rdf-meta .element-hidden property="dc:title"
content="Enhancing DCAT 1.0 dataset metadata with PROV provenance"}[]{.rdf-meta
...
::: {.field-items}
::: {.field-item .even}
[Extract provenance metadata in a standardised format](/usecase/34)
:::

::: {.field-item .odd}
[Use a dcat:Dataset as a subclass of prov:Entity](/usecase/42)
:::

::: {.field-item .even}
[View the lineage of a dataset](/usecase/1)
:::

::: {.field-item .odd}
[View the production history of a dataset](/usecase/21)
:::

::: {.field-item .even}
[View the usage of a dataset](/usecase/2)
:::
:::
:::
:::
